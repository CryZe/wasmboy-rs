...
pub mod consts {
    pub const wasmMemorySize: i32 = 9256959;
    pub const wasmBoyInternalStateLocation: i32 = 0;
    pub const wasmBoyInternalStateSize: i32 = 1024;
    pub const gameBoyInternalMemoryLocation: i32 = 1024;
    pub const gameBoyInternalMemorySize: i32 = 65535;
    pub const videoOutputLocation: i32 = 197632;
    pub const currentFrameVideoOutputLocation: i32 = 197632;
    pub const frameInProgressVideoOutputLocation: i32 = 266752;
    pub const gameboyColorPaletteLocation: i32 = 729088;
    pub const soundOutputLocation: i32 = 730112;
    pub const gameBytesLocation: i32 = 861184;
    pub const gameRamBanksLocation: i32 = 66560;
}
...
impl<I: Imports<Memory = M>, M: Memory> Instance<I, M> {
    pub fn new(imports: I, mut memory: M) -> Self {
        ...
        memory.store_slice(8894464, b" \0\0\0i\0n\0i\0t\0i\0a\0l\0i\0z\0i\0n\0g\0 \0(\0i\0n\0c\0l\0u\0d\0e\0B\0o\0o\0t\0R\0o\0m\0=\0$\00\0)");
    ...
    pub fn getRegisterA(&mut self) -> i32 {
        self.context.wasm_debug_debug_getRegisterA(&mut self.imports)
    }
    pub fn getRegisterB(&mut self) -> i32 {
        self.context.wasm_debug_debug_getRegisterB(&mut self.imports)
    }
    pub fn getRegisterC(&mut self) -> i32 {
        self.context.wasm_debug_debug_getRegisterC(&mut self.imports)
    }
    pub fn getRegisterD(&mut self) -> i32 {
        self.context.wasm_debug_debug_getRegisterD(&mut self.imports)
    }
    pub fn getRegisterE(&mut self) -> i32 {
        self.context.wasm_debug_debug_getRegisterE(&mut self.imports)
    }
    pub fn getRegisterH(&mut self) -> i32 {
        self.context.wasm_debug_debug_getRegisterH(&mut self.imports)
    }
    pub fn getRegisterL(&mut self) -> i32 {
        self.context.wasm_debug_debug_getRegisterL(&mut self.imports)
    }
    pub fn getRegisterF(&mut self) -> i32 {
        self.context.wasm_debug_debug_getRegisterF(&mut self.imports)
    }
    pub fn getProgramCounter(&mut self) -> i32 {
        self.context.wasm_debug_debug_getProgramCounter(&mut self.imports)
    }
    pub fn getStackPointer(&mut self) -> i32 {
        self.context.wasm_debug_debug_getStackPointer(&mut self.imports)
    }
    pub fn getOpcodeAtProgramCounter(&mut self) -> i32 {
        self.context.wasm_debug_debug_getOpcodeAtProgramCounter(&mut self.imports)
    }
...
impl<M: Memory> Context<M> {
    ...
    fn wasm_memory_memoryMap_getWasmBoyOffsetFromGameBoyOffset<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) -> i32 {
                    ...
                    'label3: loop {
                        'label4: loop {
                            'label5: loop {
                                ...
                                return var0.wrapping_add(861184i32);
                                break;
                            }
                            let var2 = self.wasm_memory_banking_getRomBankAddress(imports, var0);
                            return var2.wrapping_add(861184i32);
                            break;
                        }
                        ...
                        if var3 != 0 {
                            ...
                            return var0.wrapping_add(-31744i32).wrapping_add((var5 & 1i32).wrapping_mul(8192i32));
                        } else {
                            return var0.wrapping_add(-31744i32);
                        }
                        unreachable!();
                        break;
                    }
                    let var6 = self.wasm_memory_banking_getRamBankAddress(imports, var0);
                    return var6.wrapping_add(66560i32);
                    break;
                }
                return var0.wrapping_add(-31744i32);
                break;
            }
            let var7 = self.global14;
            if var7 != 0 {
                let var8 = self.global17;
                let var9 = self.wasm_memory_load_eightBitLoadFromGBMemorySkipTraps(imports, var8);
                var1 = var9 & 7i32;
                if ((var1 as u32) < 1i32 as u32) as i32 != 0 {
                    var1 = 1i32;
                }
                return var0.wrapping_add(var1.wrapping_mul(4096i32)).wrapping_add(-35840i32);
            } else {
                return var0.wrapping_add(-31744i32);
            }
            unreachable!();
        ...
        let var10 = self.global14;
        let var11: i32;
        if var10 != 0 {
            var11 = var0.wrapping_add(-7168i32);
        } else {
            var11 = var0.wrapping_add(-31744i32);
        }
        var11
    }
    ...
    fn wasm_cpu_cpu_initialize<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32) {
        ...
        self.wasm_helpers_index_log(imports, 8894464i32, 1i32, var1, -9999i32, -9999i32, -9999i32, -9999i32);
        if (var1 <= 0i32) as i32 != 0 {
            let var7 = self.global14;
            if var7 != 0 {
                self.global18 = 17i32;
                self.global19 = 128i32;
                self.global20 = 0i32;
                self.global21 = 0i32;
                self.global22 = 255i32;
                self.global23 = 86i32;
                self.global24 = 0i32;
                self.global25 = 13i32;
                self.global26 = 256i32;
                self.global27 = 65534i32;
                ...
                self.global18 = 1i32;
                self.global19 = 176i32;
                self.global20 = 0i32;
                self.global21 = 19i32;
                self.global22 = 0i32;
                self.global23 = 216i32;
                self.global24 = 1i32;
                self.global25 = 77i32;
                self.global26 = 256i32;
                self.global27 = 65534i32;
    ...
    fn wasm_sound_channel1_Channel1_updateLength<I: Imports<Memory = M>>(&mut self, imports: &mut I) {
        ...
        if var2 & 1i32 != 0 {
            ...
            self.global56 = var4.wrapping_sub(1i32);
        }
        let var5 = self.global56;
        if (var5 == 0) as i32 != 0 {
            self.global57 = 0i32;
        }
    }
    ...
    fn wasm_sound_channel1_Channel1_updateSweep<I: Imports<Memory = M>>(&mut self, imports: &mut I) {
        ...
        self.global64 = var0.wrapping_sub(1i32);
    ...
    fn wasm_sound_channel1_Channel1_updateEnvelope<I: Imports<Memory = M>>(&mut self, imports: &mut I) {
        let mut var0: i32 = 0;
        let var1 = self.global67;
        self.global67 = var1.wrapping_sub(1i32);
        let var2 = self.global67;
        if (var2 <= 0i32) as i32 != 0 {
            ...
            if var4 != 0 {
                ...
                if var6 & 1i32 != 0 {
                    let var8 = self.global68;
                    self.global68 = var8.wrapping_add(1i32);
                } else {
                    ...
                    if var10 & 1i32 != 0 {
                        let var12 = self.global68;
                        self.global68 = var12.wrapping_sub(1i32);
                    }
                }
            }
        }
    ...
    fn wasm_sound_sound_updateFrameSequencer<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) -> i32 {
        let var1 = self.global54;
        self.global54 = var1.wrapping_add(var0);
        let var2 = self.global54;
        ...
        if (var2 >= var3) as i32 != 0 {
            ...
            self.global54 = var4.wrapping_sub(var5);
            'label0: loop {
                'label1: loop {
                    'label2: loop {
                        'label3: loop {
            ...
            let var7 = self.global55;
            self.global55 = var7.wrapping_add(1i32) & 255i32;
            let var8 = self.global55;
    ...
    fn wasm_sound_channel1_Channel1_willChannelUpdate<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) -> i32 {
        ...
        self.global73 = var2.wrapping_add(var0);
    ...
    fn wasm_sound_channel1_Channel1_resetTimer<I: Imports<Memory = M>>(&mut self, imports: &mut I) {
        ...
        self.global74 = 2048i32.wrapping_sub(var0).wrapping_mul(4i32);
        let var1 = self.global41;
        if var1 != 0 {
            let var2 = self.global74;
            self.global74 = var2.wrapping_mul(2i32);
        }
    }
    ...
    fn wasm_sound_channel1_Channel1_getSample<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) -> i32 {
        let mut var1: i32 = 0;
        let var2 = self.global74;
        self.global74 = var2.wrapping_sub(var0);
        let var3 = self.global74;
        if (var3 <= 0i32) as i32 != 0 {
            ...
            self.global74 = var5.wrapping_sub(var0);
            let var6 = self.global82;
            self.global82 = var6.wrapping_add(1i32) & 255i32;
    ...
    fn wasm_sound_channel3_Channel3_resetTimer<I: Imports<Memory = M>>(&mut self, imports: &mut I) {
        ...
        self.global78 = 2048i32.wrapping_sub(var0).wrapping_mul(2i32);
        let var1 = self.global41;
        if var1 != 0 {
    ...
    fn wasm_sound_channel3_Channel3_getSample<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) -> i32 {
        ...
        let mut var2: i32 = 0;
        let var3 = self.global78;
        self.global78 = var3.wrapping_sub(var0);
        ...
        if (var4 <= 0i32) as i32 != 0 {
            ...
            let var6 = self.global78;
            self.global78 = var6.wrapping_sub(var1);
            let var7 = self.global86;
            self.global86 = var7.wrapping_add(1i32) & 65535i32;
            let var8 = self.global86;
            if (var8 as u32 >= 32i32 as u32) as i32 != 0 {
                self.global86 = 0i32;
            }
        }
        var1 = 0i32;
        let var9 = self.global87;
        var2 = var9;
        let var10 = self.global61;
        let var11: i32;
        if var10 != 0 {
            let var12 = self.wasm_sound_registers_isChannelDacEnabled(imports, 3i32);
            var11 = var12;
        } else {
            let var13 = self.global61;
            var11 = var13;
        }
        if var11 & 1i32 != 0 {
            ...
            if var14 != 0 {
                ...
                self.global87 = (var15 as u32).wrapping_shr(5i32 as u32) as i32 & 15i32;
                self.global32 = 0i32;
            }
        } else {
            return 15i32;
        }
        let var16 = self.global86;
    ...
    fn wasm_sound_channel4_Channel4_getSample<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) -> i32 {
        ...
        self.global80 = var2.wrapping_sub(var0);
        let var3 = self.global80;
        if (var3 <= 0i32) as i32 != 0 {
            ...
            self.global80 = var6.wrapping_sub(var0);
            let var7 = self.global89;
            let var8 = self.global89;
            var1 = var7 & 1i32 ^ (var8 as u32).wrapping_shr(1i32 as u32) as i32 & 1i32;
            let var9 = self.global89;
            self.global89 = (var9 as u32).wrapping_shr(1i32 as u32) as i32;
            let var10 = self.global89;
            self.global89 = (var10 | var1.wrapping_shl(14i32 as u32) & 65535i32) & 65535i32;
            let var11 = self.wasm_sound_channel4_Channel4_isNoiseChannelWidthModeSet(imports);
            if var11 != 0 {
                let var12 = self.global89;
                self.global89 = var12 & 65471i32;
                let var13 = self.global89;
                self.global89 = (var13 | var1.wrapping_shl(6i32 as u32) & 65535i32) & 65535i32;
            }
        }
        let var14 = self.global63;
        let var15: i32;
        if var14 != 0 {
            let var16 = self.wasm_sound_registers_isChannelDacEnabled(imports, 4i32);
            var15 = var16;
        } else {
            let var17 = self.global63;
            var15 = var17;
        }
        if var15 & 1i32 != 0 {
            let var18 = self.global72;
            var1 = var18;
        } else {
            return 15i32;
        }
        let var19 = self.global89;
    ...
    fn wasm_memory_memory_setLeftAndRightOutputForAudioQueue<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32, mut var2: i32) {
        let mut var3: i32 = 0;
        var3 = var2.wrapping_mul(2i32).wrapping_add(730112i32);
    ...
    fn wasm_sound_sound_accumulateSound<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) {
        ...
        if var15 & 1i32 != 0 {
            let var16 = self.global81;
            let var17 = self.global83;
            let var18 = self.global85;
            let var19 = self.global88;
            let var20 = self.wasm_sound_sound_mixChannelSamples(imports, var16, var17, var18, var19);
        }
        let var21 = self.global92;
        let var22 = self.global93;
        self.global92 = var21.wrapping_add(var0.wrapping_mul(var22));
        let var23 = self.global92;
        let var24 = self.wasm_sound_sound_Sound_maxDownSampleCycles(imports);
        if (var23 >= var24) as i32 != 0 {
            let var25 = self.global92;
            let var26 = self.wasm_sound_sound_Sound_maxDownSampleCycles(imports);
            self.global92 = var25.wrapping_sub(var26);
            let var27 = self.global33;
            let var28: i32;
            if var27 != 0 {
                let var29 = self.global33;
                var28 = var29;
            } else {
                let var30 = self.global34;
                var28 = var30;
            }
            if var28 & 1i32 != 0 {
                let var31 = self.global81;
                let var32 = self.global83;
                let var33 = self.global85;
                let var34 = self.global88;
                let var35 = self.wasm_sound_sound_mixChannelSamples(imports, var31, var32, var33, var34);
            }
            let var36 = self.global90;
            let var37 = self.global91;
            let var38 = self.global94;
            ...
            let var39 = self.global94;
            self.global94 = var39.wrapping_add(1i32);
            let var40 = self.global94;
            let var41 = self.global95;
            if (var40 >= (var41 / 2i32).wrapping_sub(1i32)) as i32 != 0 {
                let var42 = self.global94;
                self.global94 = var42.wrapping_sub(1i32);
            }
        }
    }
    ...
    fn wasm_sound_sound_calculateSound<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) {
        ...
        self.global85 = var3;
        self.global88 = var4;
        let var9 = self.global92;
        let var10 = self.global93;
        self.global92 = var9.wrapping_add(var0.wrapping_mul(var10));
        let var11 = self.global92;
        let var12 = self.wasm_sound_sound_Sound_maxDownSampleCycles(imports);
        if (var11 >= var12) as i32 != 0 {
            let var13 = self.global92;
            let var14 = self.wasm_sound_sound_Sound_maxDownSampleCycles(imports);
            self.global92 = var13.wrapping_sub(var14);
            ...
            let var19 = self.global94;
            self.global94 = var19.wrapping_add(1i32);
            let var20 = self.global94;
            let var21 = self.global95;
            if (var20 >= (var21 / 2i32).wrapping_sub(1i32)) as i32 != 0 {
                let var22 = self.global94;
                self.global94 = var22.wrapping_sub(1i32);
            }
        }
    }
    fn wasm_sound_sound_updateSound<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) {
        ...
        var1 = var2;
        let var3 = self.global39;
        let var4: i32;
        if var3 != 0 {
            var4 = (var1 == 0) as i32;
        } else {
            let var5 = self.global39;
            var4 = var5;
        }
        if var4 & 1i32 != 0 {
    ...
    fn wasm_memory_banking_handleBanking<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32) {
        ...
        if (var0 as u32 <= 8191i32 as u32) as i32 != 0 {
            ...
            if (var0 as u32 <= 16383i32 as u32) as i32 != 0 {
                ...
                if var10 & 1i32 != 0 {
                    let var11 = self.global30;
                    if var11 != 0 {
                        self.global12 = var1 & 15i32;
                    }
                    var2 = var1;
                    let var12 = self.global29;
                    if var12 != 0 {
                        var2 = var2 & 31i32;
                        let var13 = self.global12;
                        self.global12 = var13 & 224i32;
                    } else {
                        let var14 = self.global31;
                        if var14 != 0 {
                            var2 = var2 & 127i32;
                            let var15 = self.global12;
                            self.global12 = var15 & 128i32;
                        } else {
                            let var16 = self.global13;
                            if var16 != 0 {
                                let var17 = self.global12;
                                self.global12 = var17 & 0i32;
                            }
                        }
                    }
                    let var18 = self.global12;
                    self.global12 = (var18 | var2) & 65535i32;
                } else {
                    var2 = 0i32;
                    let var19 = self.global12;
                ...
                if var23 & 1i32 != 0 {
                    ...
                    if var25 & 1i32 != 0 {
                        let var28 = self.global12;
                        self.global12 = var28 & 31i32;
                        let var29 = self.global12;
                        self.global12 = (var29 | var1 & 224i32) & 65535i32;
                        return;
                    }
                    let var30 = self.global31;
                    if var30 != 0 {
    ...
    fn wasm_timers_index__checkDividerRegister<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) {
        let var1 = self.global101;
        self.global101 = var1.wrapping_add(var0);
        let var2 = self.global101;
        ...
        if (var2 >= var3) as i32 != 0 {
            ...
            self.global101 = var4.wrapping_sub(var5);
    ...
    fn wasm_timers_index_updateTimers<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) {
        ...
        let var3 = self.global102;
        self.global102 = var3.wrapping_add(var0);
        'label0: loop {
            let var4 = self.global102;
            let var5 = self.global99;
            if (var4 >= var5) as i32 != 0 {
                ...
                let var8 = self.global99;
                self.global102 = var7.wrapping_sub(var8);
    ...
    fn wasm_timers_index_batchProcessTimers<I: Imports<Memory = M>>(&mut self, imports: &mut I) {
        ...
        if var3 & 1i32 != 0 {
            let var6 = self.global99;
            var0 = var6;
        }
        let var7 = self.global100;
        ...
        'label0: loop {
            ...
            if (var8 >= var0) as i32 != 0 {
                ...
                let var9 = self.global100;
                self.global100 = var9.wrapping_sub(var0);
                continue 'label0;
            }
            break;
        }
    ...
    fn wasm_memory_dma_startDmaTransfer<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) {
        ...
        'label0: loop {
            if ((var1 as u32) < 160i32 as u32) as i32 != 0 {
        ...
        self.global103 = var3.wrapping_add(644i32);
    }
    ...
    fn wasm_memory_dma_startHdmaTransfer<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) {
        ...
        let mut var2: i32 = 0;
        let mut var3: i32 = 0;
        let var4 = self.global14;
        if (var4 == 0) as i32 != 0 {
            return;
        }
        let var5 = self.global105;
        let var6: i32;
        if var5 != 0 {
            let var7 = self.wasm_helpers_index_checkBitOnByte(imports, 7i32, var0);
            var6 = (var7 == 0) as i32;
        } else {
            let var8 = self.global105;
            var6 = var8;
        }
        if var6 & 1i32 != 0 {
            self.global105 = 0i32;
        ...
        if var13 != 0 {
            ...
            let var15 = self.global104;
            self.wasm_memory_store_eightBitStoreIntoGBMemorySkipTraps(imports, var15, 255i32);
            let var16 = self.global41;
            if var16 != 0 {
                let var17 = self.global103;
                self.global103 = var17.wrapping_add(64i32);
            } else {
                let var18 = self.global103;
                self.global103 = var18.wrapping_add(32i32);
            }
        }
    }
    fn wasm_memory_memory_storePaletteByteInWasmMemory<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32, mut var2: i32) {
        ...
        self.memory.store8(var3.wrapping_add(729088i32) as usize, var1 as u8);
    }
    ...
    fn wasm_memory_writeTraps_checkWriteTraps<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32, mut var2: i32) -> i32 {
        ...
        let var16 = self.global17;
        var3 = (var0 == var16) as i32;
        let var17: i32;
        if var3 != 0 {
            var17 = var3;
        } else {
            let var18 = self.global15;
            var17 = (var0 == var18) as i32;
        }
        if var17 & 1i32 != 0 {
            let var19 = self.global105;
            if var19 != 0 {
                let var20 = self.global108;
                var3 = (var20 as u32 >= 16384i32 as u32) as i32;
                let var21: i32;
                if var3 != 0 {
                    let var22 = self.global108;
                ...
                if var3 != 0 {
                    ...
                    let var24 = self.global108;
                    var3 = (var24 as u32 >= 53248i32 as u32) as i32;
                    let var25: i32;
                    if var3 != 0 {
                        let var26 = self.global108;
        ...
        let var27 = self.global114;
        var3 = (var0 as u32 >= var27 as u32) as i32;
        let var28: i32;
        if var3 != 0 {
            let var29 = self.global115;
    ...
    fn wasm_cpu_flags_setFlagBit<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32) -> i32 {
        ...
        if (var1 as u32 > 0i32 as u32) as i32 != 0 {
            ...
            self.global19 = (var3 | var2) & 255i32;
        } else {
            let var4 = self.global19;
            self.global19 = var4 & (var2 ^ 255i32);
        }
        let var5 = self.global19;
        var5
    }
        ...
        'label0: loop {
            'label1: loop {
                'label2: loop {
                    'label3: loop {
                        'label4: loop {
                            'label5: loop {
                                            ...
                                            'label9: loop {
                                                'label10: loop {
                                                    'label11: loop {
                                                        ...
                                                        let var17 = self.global20;
                                                        self.global20 = var17.wrapping_add(1i32) & 255i32;
                                                        let var18 = self.global20;
                                                        if var18 != 0 {
                                                    ...
                                                    let var20 = self.global20;
                                                    self.global20 = var20.wrapping_sub(1i32) & 255i32;
                                                    let var21 = self.global20;
                                                    if var21 != 0 {
                                                        self.wasm_cpu_flags_setZeroFlag(imports, 0i32);
                                                    } else {
                                                        self.wasm_cpu_flags_setZeroFlag(imports, 1i32);
                                                ...
                                                self.global26 = var22.wrapping_add(1i32) & 65535i32;
                                                return 8i32;
                                                break;
                                            }
                                            let var23 = self.global18;
                                            if (var23 & 128i32 == 128i32) as i32 != 0 {
                                                self.wasm_cpu_flags_setCarryFlag(imports, 1i32);
                                            } else {
                                                self.wasm_cpu_flags_setCarryFlag(imports, 0i32);
                                            }
                                            let var24 = self.global18;
                                ...
                                let var36 = self.global20;
                                let var37 = self.global21;
                            ...
                            let var40 = self.global20;
                            let var41 = self.global21;
                        ...
                        let var45 = self.global21;
                        self.wasm_cpu_flags_checkAndSetEightBitHalfCarryFlag(imports, var45, 1i32);
                        let var46 = self.global21;
                        self.global21 = var46.wrapping_add(1i32) & 255i32;
                        let var47 = self.global21;
                        if var47 != 0 {
                            self.wasm_cpu_flags_setZeroFlag(imports, 0i32);
                        } else {
                            self.wasm_cpu_flags_setZeroFlag(imports, 1i32);
                    ...
                    let var48 = self.global21;
                    self.wasm_cpu_flags_checkAndSetEightBitHalfCarryFlag(imports, var48, -1i32);
                    let var49 = self.global21;
                    self.global21 = var49.wrapping_sub(1i32) & 255i32;
                    let var50 = self.global21;
                    if var50 != 0 {
                        self.wasm_cpu_flags_setZeroFlag(imports, 0i32);
                    } else {
                        self.wasm_cpu_flags_setZeroFlag(imports, 1i32);
                ...
                self.global21 = var1;
                let var51 = self.global26;
                self.global26 = var51.wrapping_add(1i32) & 65535i32;
                return 8i32;
                break;
            }
            let var52 = self.global18;
            if ((var52 & 1i32) as u32 > 0i32 as u32) as i32 != 0 {
                self.wasm_cpu_flags_setCarryFlag(imports, 1i32);
            } else {
                self.wasm_cpu_flags_setCarryFlag(imports, 0i32);
            }
            let var53 = self.global18;
    ...
    fn wasm_cpu_instructions_relativeJump<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) {
        ...
        self.global26 = var1.wrapping_add(var0.wrapping_shl(24i32 as u32).wrapping_shr(24i32 as u32)) & 65535i32;
        let var2 = self.global26;
        self.global26 = var2.wrapping_add(1i32) & 65535i32;
    }
            ...
            'label1: loop {
                'label2: loop {
                    'label3: loop {
                        'label4: loop {
                            'label5: loop {
                                'label6: loop {
                                            ...
                                            'label9: loop {
                                                'label10: loop {
                                                    'label11: loop {
                                                            ...
                                                            'label13: loop {
                                                                'label14: loop {
                                                                    'label15: loop {
                                                                        ...
                                                                        self.global26 = var12.wrapping_add(1i32) & 65535i32;
                                                                        return 4i32;
                                                                        break;
                                                                    }
                                                        ...
                                                        let var25 = self.global22;
                                                        self.wasm_cpu_flags_checkAndSetEightBitHalfCarryFlag(imports, var25, 1i32);
                                                        let var26 = self.global22;
                                                        self.global22 = var26.wrapping_add(1i32) & 255i32;
                                                ...
                                                self.global22 = var1;
                                                let var31 = self.global26;
                                                self.global26 = var31.wrapping_add(1i32) & 65535i32;
                                                return 8i32;
                                                break;
                                            }
                                            var0 = 0i32;
                                            let var32 = self.global18;
                                            if (var32 & 128i32 == 128i32) as i32 != 0 {
                                                var0 = 1i32;
                                            }
                                            let var33 = self.global18;
                                    ...
                                    var0 = var37;
                                    let var38 = self.global22;
                                    let var39 = self.global23;
                                ...
                                let var43 = self.global22;
                                let var44 = self.global23;
                        ...
                        let var52 = self.global23;
                        self.wasm_cpu_flags_checkAndSetEightBitHalfCarryFlag(imports, var52, 1i32);
                        let var53 = self.global23;
                        self.global23 = var53.wrapping_add(1i32) & 255i32;
                        let var54 = self.global23;
                        if var54 != 0 {
                            self.wasm_cpu_flags_setZeroFlag(imports, 0i32);
                        } else {
                            self.wasm_cpu_flags_setZeroFlag(imports, 1i32);
                    ...
                    let var55 = self.global23;
                    self.wasm_cpu_flags_checkAndSetEightBitHalfCarryFlag(imports, var55, -1i32);
                    let var56 = self.global23;
                    self.global23 = var56.wrapping_sub(1i32) & 255i32;
                    let var57 = self.global23;
                    if var57 != 0 {
                        self.wasm_cpu_flags_setZeroFlag(imports, 0i32);
                    } else {
                        self.wasm_cpu_flags_setZeroFlag(imports, 1i32);
                ...
                self.global23 = var1;
                let var58 = self.global26;
                self.global26 = var58.wrapping_add(1i32) & 65535i32;
                return 8i32;
                break;
            }
            var0 = 0i32;
            let var59 = self.global18;
            if (var59 & 1i32 == 1i32) as i32 != 0 {
                var0 = 1i32;
            }
            let var60 = self.global18;
        ...
        'label0: loop {
            'label1: loop {
                'label2: loop {
                    'label3: loop {
                        'label4: loop {
                            'label5: loop {
                                'label6: loop {
                                    'label7: loop {
                                            ...
                                            'label9: loop {
                                                'label10: loop {
                                                    'label11: loop {
                                                                ...
                                                                'label14: loop {
                                                                    'label15: loop {
                                                                        ...
                                                                        if var4 != 0 {
                                                                            ...
                                                                            self.global26 = var5.wrapping_add(1i32) & 65535i32;
                                                                            return 8i32;
                                                                        } else {
                                                                            self.wasm_cpu_instructions_relativeJump(imports, var1);
                                                                            return 12i32;
                                                                    ...
                                                                    self.global26 = var8.wrapping_add(2i32) & 65535i32;
                                                                    return 12i32;
                                                                    break;
                                                                }
                                                        ...
                                                        let var21 = self.global24;
                                                        self.global24 = var21.wrapping_add(1i32) & 255i32;
                                                        let var22 = self.global24;
                                                        if var22 != 0 {
                                                            self.wasm_cpu_flags_setZeroFlag(imports, 0i32);
                                                        } else {
                                                            self.wasm_cpu_flags_setZeroFlag(imports, 1i32);
                                                ...
                                                self.global24 = var1;
                                                let var26 = self.global26;
                                                self.global26 = var26.wrapping_add(1i32) & 65535i32;
                                                return 8i32;
                                                break;
                                            }
                                            var1 = 0i32;
                                        ...
                                        if (var35 as u32 > 0i32 as u32) as i32 != 0 {
                                            ...
                                            let var36 = self.global26;
                                            self.global26 = var36.wrapping_add(1i32) & 65535i32;
                                            return 8i32;
                                        }
                                        unreachable!();
                                        break;
                                    }
                                    let var37 = self.global24;
                                    let var38 = self.global25;
                                ...
                                let var42 = self.global24;
                                let var43 = self.global25;
                            ...
                            let var48 = self.global24;
                            let var49 = self.global25;
                        ...
                        self.global25 = var54.wrapping_add(1i32) & 255i32;
                    ...
                    self.global25 = var57.wrapping_sub(1i32) & 255i32;
                    let var58 = self.global25;
                    if var58 != 0 {
                        self.wasm_cpu_flags_setZeroFlag(imports, 0i32);
                    } else {
                        self.wasm_cpu_flags_setZeroFlag(imports, 1i32);
                ...
                self.global25 = var1;
                let var59 = self.global26;
                self.global26 = var59.wrapping_add(1i32) & 65535i32;
                return 8i32;
                break;
            }
            let var60 = self.global18;
            self.global18 = (var60 ^ -1i32) & 255i32;
            self.wasm_cpu_flags_setSubtractFlag(imports, 1i32);
            self.wasm_cpu_flags_setHalfCarryFlag(imports, 1i32);
            return 4i32;
            break;
    ...
    fn wasm_cpu_opcodes_handleOpcode3x<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32, mut var2: i32, mut var3: i32) -> i32 {
        'label0: loop {
            'label1: loop {
                'label2: loop {
                    'label3: loop {
                        'label4: loop {
                                    ...
                                    'label7: loop {
                                        'label8: loop {
                                            'label9: loop {
                                                'label10: loop {
                                                    'label11: loop {
                                                        'label12: loop {
                                                            ...
                                                            self.global27 = var13.wrapping_add(1i32) & 65535i32;
                                                            return 8i32;
                                                            break;
                                                        }
                                                        let var14 = self.global24;
                                                ...
                                                self.global26 = var25.wrapping_add(1i32) & 65535i32;
                                                return 12i32;
                                                break;
                                            }
                                            self.wasm_cpu_flags_setSubtractFlag(imports, 0i32);
                                        ...
                                        if (var26 == 1i32) as i32 != 0 {
                                            ...
                                            let var27 = self.global26;
                                            self.global26 = var27.wrapping_add(1i32) & 65535i32;
                                            return 8i32;
                                        }
                                        unreachable!();
                                        break;
                            ...
                            let var41 = self.global27;
                            self.global27 = var41.wrapping_sub(1i32) & 65535i32;
                            return 8i32;
                            break;
                        }
                        let var42 = self.global18;
                        self.wasm_cpu_flags_checkAndSetEightBitHalfCarryFlag(imports, var42, 1i32);
                        let var43 = self.global18;
                        self.global18 = var43.wrapping_add(1i32) & 255i32;
                        let var44 = self.global18;
                        if var44 != 0 {
                            self.wasm_cpu_flags_setZeroFlag(imports, 0i32);
                        } else {
                            self.wasm_cpu_flags_setZeroFlag(imports, 1i32);
                    ...
                    let var45 = self.global18;
                    self.wasm_cpu_flags_checkAndSetEightBitHalfCarryFlag(imports, var45, -1i32);
                    let var46 = self.global18;
                    self.global18 = var46.wrapping_sub(1i32) & 255i32;
                    let var47 = self.global18;
                    if var47 != 0 {
                        self.wasm_cpu_flags_setZeroFlag(imports, 0i32);
                    } else {
                        self.wasm_cpu_flags_setZeroFlag(imports, 1i32);
                ...
                self.global26 = var48.wrapping_add(1i32) & 65535i32;
                return 8i32;
                break;
            }
            self.wasm_cpu_flags_setSubtractFlag(imports, 0i32);
    ...
    fn wasm_cpu_opcodes_handleOpcode4x<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32, mut var2: i32, mut var3: i32) -> i32 {
        'label0: loop {
            'label1: loop {
                                                    ...
                                                    'label11: loop {
                                                        'label12: loop {
                                                            'label13: loop {
                                                                ...
                                                                let var5 = self.global22;
                                                                self.global20 = var5;
                                                                return 4i32;
                                                                break;
                                                            }
                                                            let var6 = self.global23;
                                                            self.global20 = var6;
                                                            return 4i32;
                                                            break;
                                                        }
                ...
                let var19 = self.global24;
                let var20 = self.global25;
    ...
    fn wasm_cpu_opcodes_handleOpcode7x<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32, mut var2: i32, mut var3: i32) -> i32 {
        'label0: loop {
            'label1: loop {
                        ...
                        'label4: loop {
                            'label5: loop {
                                'label6: loop {
                                    ...
                                    let var34 = self.global21;
                                    self.global18 = var34;
                                    return 4i32;
                                    break;
                                }
                                let var35 = self.global22;
                                self.global18 = var35;
                                return 4i32;
                                break;
                            }
                            let var36 = self.global23;
                            self.global18 = var36;
                            return 4i32;
                            break;
                        }
                ...
                let var39 = self.global24;
                let var40 = self.global25;
                                    ...
                                    'label7: loop {
                                        'label8: loop {
                                            'label9: loop {
                                                ...
                                                let var10 = self.global24;
                                                let var11 = self.global25;
    ...
    fn wasm_cpu_instructions_subARegister<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) {
        ...
        let var4 = self.global18;
        self.global18 = var4.wrapping_sub(var0) & 255i32;
        let var5 = self.global18;
        if var5 != 0 {
            self.wasm_cpu_flags_setZeroFlag(imports, 0i32);
        } else {
    ...
    fn wasm_cpu_instructions_andARegister<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) {
        let var1 = self.global18;
        self.global18 = var1 & var0 & 255i32;
        let var2 = self.global18;
        if var2 != 0 {
            self.wasm_cpu_flags_setZeroFlag(imports, 0i32);
        } else {
    ...
    fn wasm_cpu_cbOpcodes_handleCbOpcode<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) -> i32 {
                    ...
                    'label3: loop {
                        'label4: loop {
                            'label5: loop {
                                ...
                                let var8 = self.global22;
                                var1 = var8;
                                break 'label0;
                                break;
                            }
                            let var9 = self.global23;
                            var1 = var9;
                            break 'label0;
                            break;
                        }
        ...
        'label28: loop {
            'label29: loop {
                ...
                let var49 = self.global24;
                let var50 = self.global25;
        ...
        let var52 = self.global26;
        self.global26 = var52.wrapping_add(1i32) & 65535i32;
        if var3 != 0 {
            var4 = 8i32;
    ...
    fn wasm_cpu_opcodes_handleOpcodeCx<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32, mut var2: i32, mut var3: i32) -> i32 {
        ...
        'label0: loop {
                ...
                'label2: loop {
                    'label3: loop {
                        'label4: loop {
                            'label5: loop {
                                'label6: loop {
                                    'label7: loop {
                                        'label8: loop {
                                            'label9: loop {
                                                'label10: loop {
                                                    'label11: loop {
                                                        'label12: loop {
                                                            'label13: loop {
                                                                'label14: loop {
                                                                    'label15: loop {
                                                                        ...
                                                                        if var5 != 0 {
                                                                            ...
                                                                            self.global27 = var8.wrapping_add(2i32) & 65535i32;
                                                                            return 20i32;
                                                                        }
                                                                        unreachable!();
                                                                        break;
                                                                ...
                                                                if var17 != 0 {
                                                                    ...
                                                                    self.global26 = var18.wrapping_add(2i32) & 65535i32;
                                                                    return 12i32;
                                                                } else {
                                                                    self.global26 = var3;
                                                                    return 16i32;
                                                        ...
                                                        if var19 != 0 {
                                                            ...
                                                            self.global26 = var20.wrapping_add(2i32) & 65535i32;
                                                            return 12i32;
                                                        } else {
                                                            let var21 = self.global27;
                                                            self.global27 = var21.wrapping_sub(2i32) & 65535i32;
                                                    ...
                                                    self.global27 = var27.wrapping_sub(2i32) & 65535i32;
                                                    let var28 = self.global27;
                                                ...
                                                self.global26 = var29.wrapping_add(1i32) & 65535i32;
                                                return 8i32;
                                                break;
                                            }
                                            let var30 = self.global27;
                                            self.global27 = var30.wrapping_sub(2i32) & 65535i32;
                                            let var31 = self.global27;
                                            let var32 = self.global26;
                                    ...
                                    let var37 = self.global27;
                                    let var38 = self.wasm_memory_load_sixteenBitLoadFromGBMemory(imports, var37);
                                    self.global26 = var38;
                                    let var39 = self.global27;
                                    self.global27 = var39.wrapping_add(2i32) & 65535i32;
                                    return 16i32;
                                    break;
                                }
                                ...
                                if (var40 == 1i32) as i32 != 0 {
                                    ...
                                    let var41 = self.global26;
                                    self.global26 = var41.wrapping_add(2i32) & 65535i32;
                                    return 12i32;
                                }
                                unreachable!();
                                break;
                        ...
                        if (var43 == 1i32) as i32 != 0 {
                            let var44 = self.global27;
                            self.global27 = var44.wrapping_sub(2i32) & 65535i32;
                            let var45 = self.global27;
                            let var46 = self.global26;
                            self.wasm_memory_store_sixteenBitStoreIntoGBMemory(imports, var45, var46.wrapping_add(2i32) & 65535i32);
                            self.global26 = var3;
                            return 24i32;
                        } else {
                            let var47 = self.global26;
                            self.global26 = var47.wrapping_add(2i32) & 65535i32;
                            return 12i32;
                        }
                        unreachable!();
                        break;
                    }
                    let var48 = self.global27;
                    self.global27 = var48.wrapping_sub(2i32) & 65535i32;
                    let var49 = self.global27;
                    let var50 = self.global26;
            ...
            let var52 = self.global27;
            self.global27 = var52.wrapping_sub(2i32) & 65535i32;
            let var53 = self.global27;
            let var54 = self.global26;
            ...
            'label1: loop {
                'label2: loop {
                    ...
                    if (var42 == 1i32) as i32 != 0 {
                        ...
                        self.global27 = var43.wrapping_sub(2i32) & 65535i32;
                        let var44 = self.global27;
                        let var45 = self.global26;
                        self.wasm_memory_store_sixteenBitStoreIntoGBMemory(imports, var44, var45.wrapping_add(2i32) & 65535i32);
                        self.global26 = var3;
                        return 24i32;
                    } else {
                        let var46 = self.global26;
                        self.global26 = var46.wrapping_add(2i32) & 65535i32;
                        return 12i32;
                    }
                    unreachable!();
                    break;
                ...
                let var47 = self.global26;
                self.global26 = var47.wrapping_add(1i32) & 65535i32;
                return 8i32;
                break;
            }
            let var48 = self.global27;
                ...
                'label2: loop {
                    'label3: loop {
                        'label4: loop {
                            'label5: loop {
                                'label6: loop {
                                    'label7: loop {
                                        'label8: loop {
                                            'label9: loop {
                                                'label10: loop {
                                                    ...
                                                    let var6 = self.global26;
                                                    self.global26 = var6.wrapping_add(1i32) & 65535i32;
                                                    return 12i32;
                                                    break;
                                                }
                                                let var7 = self.global24;
                                                ...
                                                var4 = var11;
                                                let var12 = self.global27;
                                                self.global27 = var12.wrapping_add(2i32) & 65535i32;
                                        ...
                                        self.global27 = var20.wrapping_sub(2i32) & 65535i32;
                                        let var21 = self.global27;
                                ...
                                self.global27 = var23.wrapping_sub(2i32) & 65535i32;
                            ...
                            let var27 = self.global27;
                            self.global27 = var27.wrapping_add(var4) & 65535i32;
                            self.wasm_cpu_flags_setZeroFlag(imports, 0i32);
                            self.wasm_cpu_flags_setSubtractFlag(imports, 0i32);
                            let var28 = self.global26;
                            self.global26 = var28.wrapping_add(1i32) & 65535i32;
                            return 16i32;
                            break;
                        }
                        let var29 = self.global24;
                    ...
                    let var33 = self.global26;
                    self.global26 = var33.wrapping_add(2i32) & 65535i32;
                    return 16i32;
                    break;
                }
                self.wasm_cpu_instructions_xorARegister(imports, var1);
                let var34 = self.global26;
                self.global26 = var34.wrapping_add(1i32) & 65535i32;
                return 8i32;
                break;
            }
            let var35 = self.global27;
            self.global27 = var35.wrapping_sub(2i32) & 65535i32;
            let var36 = self.global27;
            ...
            'label1: loop {
                'label2: loop {
                    'label3: loop {
                                ...
                                'label6: loop {
                                    'label7: loop {
                                        'label8: loop {
                                            'label9: loop {
                                                'label10: loop {
                                                    'label11: loop {
                                                        ...
                                                        let var6 = self.global18;
                                                        let var7 = self.global19;
                                                        ...
                                                        self.global27 = var11.wrapping_add(2i32) & 65535i32;
                                            ...
                                            self.global27 = var19.wrapping_sub(2i32) & 65535i32;
                                            let var20 = self.global27;
                                        ...
                                        self.global26 = var21.wrapping_add(1i32) & 65535i32;
                                        return 8i32;
                                        break;
                                    }
                                    let var22 = self.global27;
                                    self.global27 = var22.wrapping_sub(2i32) & 65535i32;
                                    let var23 = self.global27;
                        ...
                        self.global18 = var33;
                        let var34 = self.global26;
                        self.global26 = var34.wrapping_add(2i32) & 65535i32;
                        return 16i32;
                        break;
                    }
                    self.wasm_interrupts_index_setInterrupts(imports, 1i32);
                ...
                self.global26 = var35.wrapping_add(1i32) & 65535i32;
                return 8i32;
                break;
            }
            let var36 = self.global27;
            self.global27 = var36.wrapping_sub(2i32) & 65535i32;
            let var37 = self.global27;
            let var38 = self.global26;
    ...
    fn wasm_cpu_opcodes_executeOpcode<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32, mut var2: i32) -> i32 {
        ...
        self.global26 = var4.wrapping_add(1i32) & 65535i32;
    ...
    fn wasm_interrupts_index__handleInterrupt<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) {
        ...
        self.wasm_memory_store_eightBitStoreIntoGBMemorySkipTraps(imports, 65295i32, var2);
        let var3 = self.global27;
        self.global27 = var3.wrapping_sub(2i32) & 65535i32;
        let var4 = self.global27;
        let var5 = self.global26;
    ...
    fn wasm_memory_memory_loadFromVramBank<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32) -> i32 {
        let var2 = self.memory.load8(var0.wrapping_add(-31744i32).wrapping_add((var1 & 1i32).wrapping_mul(8192i32)) as usize) as i32;
        var2
    }
    ...
    fn wasm_memory_memory_loadPaletteByteFromWasmMemory<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32) -> i32 {
        ...
        let var3 = self.memory.load8(var2.wrapping_add(729088i32) as usize) as i32;
        var3
    }
    ...
    fn wasm_memory_memory_setPixelOnFrame<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32, mut var2: i32, mut var3: i32) {
        ...
        self.memory.store8(var4.wrapping_add(266752i32).wrapping_add(var2) as usize, var3.wrapping_add(1i32) as u8);
    }
    fn wasm_graphics_backgroundWindow_drawColorPixelFromTile<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32, mut var2: i32, mut var3: i32, mut var4: i32, mut var5: i32) {
        ...
        var2 = var16;
        let var17 = self.wasm_graphics_palette_getColorComponentFromRgb(imports, 0i32, var2);
        var3 = var17;
        let var18 = self.wasm_graphics_palette_getColorComponentFromRgb(imports, 1i32, var2);
        var4 = var18;
        let var19 = self.wasm_graphics_palette_getColorComponentFromRgb(imports, 2i32, var2);
        var2 = var19;
        self.wasm_memory_memory_setPixelOnFrame(imports, var0, var1, 0i32, var3);
        self.wasm_memory_memory_setPixelOnFrame(imports, var0, var1, 1i32, var4);
        self.wasm_memory_memory_setPixelOnFrame(imports, var0, var1, 2i32, var2);
    }
    fn wasm_graphics_palette_getMonochromeColorFromPalette<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32) -> i32 {
        let mut var2: i32 = 0;
        var2 = 242i32;
        'label0: loop {
            'label1: loop {
                'label2: loop {
                    'label3: loop {
                        'label4: loop {
                            ...
                            match (var3 as u32).wrapping_shr((var0.wrapping_mul(2i32) & 255i32) as u32) as i32 & 3i32 {
                                0 => break 'label0,
                                1 => break 'label3,
                                2 => break 'label2,
                                3 => break 'label1,
    ...
    fn wasm_graphics_backgroundWindow_drawMonochromePixelFromTile<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32, mut var2: i32, mut var3: i32, mut var4: i32) {
        ...
        let var10 = self.wasm_graphics_palette_getMonochromeColorFromPalette(imports, var3, 65351i32);
        var2 = var10;
    ...
    fn wasm_memory_memory_getPixelOnFrame<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32) -> i32 {
        let var2 = self.wasm_memory_memory_getRgbPixelStart(imports, var0, var1);
        let var3 = self.memory.load8(var2.wrapping_add(266752i32) as usize) as i32;
        var3
    }
    fn wasm_graphics_sprites_renderSprites<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32) {
        ...
        let mut var13: i32 = 0;
        'label0: loop {
            if ((var7) < 40i32) as i32 != 0 {
                var3 = var7.wrapping_mul(4i32) & 65535i32;
                let var14 = self.wasm_memory_load_eightBitLoadFromGBMemorySkipTraps(imports, var3.wrapping_add(65024i32) & 65535i32);
                var2 = var14.wrapping_sub(16i32) & 255i32;
                let var15 = self.wasm_memory_load_eightBitLoadFromGBMemorySkipTraps(imports, var3.wrapping_add(65025i32) & 65535i32);
                var9 = var15.wrapping_sub(8i32) & 255i32;
                let var16 = self.wasm_memory_load_eightBitLoadFromGBMemorySkipTraps(imports, var3.wrapping_add(65026i32) & 65535i32);
                var5 = var16;
                let var17 = self.wasm_memory_load_eightBitLoadFromGBMemorySkipTraps(imports, var3.wrapping_add(65027i32) & 65535i32);
                var6 = var17;
                let var18 = self.wasm_helpers_index_checkBitOnByte(imports, 7i32, var6);
                var10 = var18;
                let var19 = self.wasm_helpers_index_checkBitOnByte(imports, 6i32, var6);
                var8 = var19;
                let var20 = self.wasm_helpers_index_checkBitOnByte(imports, 5i32, var6);
                var11 = var20;
                var4 = 8i32;
                if var1 != 0 {
                    var4 = 16i32;
                ...
                let var21: i32;
                if var3 != 0 {
                    var21 = ((var0 as u32) < (var2.wrapping_add(var4) & 255i32) as u32) as i32;
                } else {
                    var21 = var3;
                }
                if var21 & 1i32 != 0 {
                    ...
                    if var8 != 0 {
                        var3 = var3.wrapping_sub(var4).wrapping_shl(16i32 as u32).wrapping_shr(16i32 as u32).wrapping_mul(-1i32).wrapping_shl(16i32 as u32).wrapping_shr(16i32 as u32).wrapping_sub(1i32).wrapping_shl(16i32 as u32).wrapping_shr(16i32 as u32);
                    }
                    let var22 = self.wasm_graphics_renderUtils_getTileDataAddress(imports, 32768i32, var5);
                    var2 = var22.wrapping_add(var3.wrapping_mul(2i32).wrapping_shl(16i32 as u32).wrapping_shr(16i32 as u32));
                    var3 = 0i32;
                    let var23 = self.global14;
                    let var24: i32;
                    if var23 != 0 {
                        let var25 = self.wasm_helpers_index_checkBitOnByte(imports, 3i32, var6);
                        var24 = var25;
                    } else {
                    ...
                    var2 = var2 & 65535i32;
                    let var27 = self.wasm_memory_memory_loadFromVramBank(imports, var2, var3);
                    var8 = var27;
                    let var28 = self.wasm_memory_memory_loadFromVramBank(imports, var2.wrapping_add(1i32) & 65535i32, var3);
                    var12 = var28;
                    var3 = 7i32;
                    'label1: loop {
                        if (var3 >= 0i32) as i32 != 0 {
                            ...
                            var4 = 0i32;
                            let var29 = self.wasm_helpers_index_checkBitOnByte(imports, var2 & 255i32, var12);
                            if var29 != 0 {
                                var4 = 2i32;
                            }
                            let var30 = self.wasm_helpers_index_checkBitOnByte(imports, var2 & 255i32, var8);
                            if var30 != 0 {
                                var4 = var4.wrapping_add(1i32) & 255i32;
                            }
                            if var4 != 0 {
                                var2 = var9.wrapping_add(7i32.wrapping_sub(var3 & 255i32) & 255i32) & 255i32;
                                var5 = (var10 == 0) as i32;
                                let var31: i32;
                                if var5 != 0 {
                                    var31 = var5;
                                } else {
                                    let var32 = self.wasm_memory_memory_getPixelOnFrame(imports, var2, var0);
                                    var31 = (var32 as u32 >= 200i32 as u32) as i32;
                                }
                                if var31 & 1i32 != 0 {
                                    let var33 = self.global14;
                                    if var33 != 0 {
                                        let var34 = self.wasm_graphics_palette_getRgbColorFromPalette(imports, var6 & 7i32, var4, 1i32);
                                        var5 = var34;
                                        let var35 = self.wasm_graphics_palette_getColorComponentFromRgb(imports, 0i32, var5);
                                        var4 = var35;
                                        let var36 = self.wasm_graphics_palette_getColorComponentFromRgb(imports, 1i32, var5);
                                        var13 = var36;
                                        let var37 = self.wasm_graphics_palette_getColorComponentFromRgb(imports, 2i32, var5);
                                        var5 = var37;
                                        self.wasm_memory_memory_setPixelOnFrame(imports, var2, var0, 0i32, var4);
                                        self.wasm_memory_memory_setPixelOnFrame(imports, var2, var0, 1i32, var13);
                                        self.wasm_memory_memory_setPixelOnFrame(imports, var2, var0, 2i32, var5);
                                    } else {
                                        var5 = 65352i32;
                                        let var38 = self.wasm_helpers_index_checkBitOnByte(imports, 4i32, var6);
                                        if var38 != 0 {
                                            var5 = 65353i32;
                                        }
                                        let var39 = self.wasm_graphics_palette_getMonochromeColorFromPalette(imports, var4, var5);
                                        var4 = var39;
                                        self.wasm_memory_memory_setPixelOnFrame(imports, var2, var0, 0i32, var4);
                                        self.wasm_memory_memory_setPixelOnFrame(imports, var2, var0, 1i32, var4);
                                        self.wasm_memory_memory_setPixelOnFrame(imports, var2, var0, 2i32, var4);
                                    }
                                }
                            }
    ...
    fn wasm_graphics_graphics__drawScanline<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32) {
        ...
        let var6 = self.wasm_helpers_index_checkBitOnByte(imports, 0i32, var1);
        if var6 != 0 {
            var2 = 38912i32;
            let var7 = self.wasm_helpers_index_checkBitOnByte(imports, 3i32, var1);
            if var7 != 0 {
                var2 = 39936i32;
            }
            self.wasm_graphics_backgroundWindow_renderBackground(imports, var0, var3, var2);
        }
        let var8 = self.wasm_helpers_index_checkBitOnByte(imports, 5i32, var1);
        if var8 != 0 {
            var2 = 38912i32;
            let var9 = self.wasm_helpers_index_checkBitOnByte(imports, 6i32, var1);
            if var9 != 0 {
                var2 = 39936i32;
            }
            self.wasm_graphics_backgroundWindow_renderWindow(imports, var0, var3, var2);
        }
        let var10 = self.wasm_helpers_index_checkBitOnByte(imports, 1i32, var1);
        if var10 != 0 {
            let var11 = self.wasm_helpers_index_checkBitOnByte(imports, 2i32, var1);
            self.wasm_graphics_sprites_renderSprites(imports, var0, var11);
        }
    }
            ...
            if ((var1) < 144i32) as i32 != 0 {
                ...
                'label1: loop {
                    if ((var2) < 160i32) as i32 != 0 {
                        ...
                        'label2: loop {
                            if ((var0) < 3i32) as i32 != 0 {
                                let var7 = self.memory.load8(266752i32.wrapping_add(var3).wrapping_add(var0) as usize) as i32;
                                self.memory.store8(197632i32.wrapping_add(var3).wrapping_add(var0) as usize, var7 as u8);
    ...
    fn wasm_memory_dma_updateHblankHdma<I: Imports<Memory = M>>(&mut self, imports: &mut I) {
        ...
        let var12 = self.global106;
        self.global106 = var12.wrapping_add(var0);
        let var13 = self.global106;
        let var14 = self.global107;
        if (var13 >= var14) as i32 != 0 {
            self.global105 = 0i32;
            self.global106 = 0i32;
            self.global107 = 0i32;
            ...
            let var16 = self.global104;
            let var17 = self.global107;
            let var18 = self.global106;
    ...
    fn wasm_cpu_opcodes_emulationStep<I: Imports<Memory = M>>(&mut self, imports: &mut I, mut var0: i32, mut var1: i32, mut var2: i32) -> i32 {
        ...
        if var6 & 1i32 != 0 {
            ...
            if var19 & 1i32 != 0 {
                ...
                var3 = var27;
                let var28 = self.global26;
                self.global26 = var28.wrapping_sub(1i32) & 65535i32;
            }
        }
        let var29 = self.global19;
        self.global19 = var29 & 240i32;
        if (var3 <= 0i32) as i32 != 0 {
            return var3;
        }
        let var30 = self.global103;
        if (var30 > 0i32) as i32 != 0 {
            let var31 = self.global103;
    ...
    fn wasm_cpu_opcodes_update<I: Imports<Memory = M>>(&mut self, imports: &mut I) -> i32 {
        ...
        let mut var3: i32 = 0;
        let mut var4: i32 = 0;
        let var5 = self.global35;
        var1 = var5;
        let var6 = self.global36;
        var2 = var6;
        let var7 = self.global37;
        var3 = var7;
        'label0: loop {
            var0 = (var4 == 0) as i32;
            let var8: i32;
            ...
            if var8 & 1i32 != 0 {
                ...
                var0 = var11;
                if (var0 >= 0i32) as i32 != 0 {
                    let var12 = self.global40;
                    self.global40 = var12.wrapping_add(var0);
                    if var1 != 0 {
                        let var13 = self.global53;
                        self.global53 = var13.wrapping_add(var0);
                    }
                    if var2 != 0 {
                        let var14 = self.global119;
                        self.global119 = var14.wrapping_add(var0);
                        self.wasm_graphics_graphics_batchProcessGraphics(imports);
                    }
                    if var3 != 0 {
                        let var15 = self.global100;
                        self.global100 = var15.wrapping_add(var0);
                        self.wasm_timers_index_batchProcessTimers(imports);
                    }
                } else {
                    var4 = 1i32;
    ...
    fn wasm_sound_sound_getAudioQueueIndex<I: Imports<Memory = M>>(&mut self, imports: &mut I) -> i32 {
        let var0 = self.global94;
        var0
    }
    fn wasm_sound_sound_resetAudioQueue<I: Imports<Memory = M>>(&mut self, imports: &mut I) {
        self.global94 = 0i32;
    }
    fn wasm_debug_debug_getRegisterA<I: Imports<Memory = M>>(&mut self, imports: &mut I) -> i32 {
        let var0 = self.global18;
        var0
    }
    fn wasm_debug_debug_getRegisterB<I: Imports<Memory = M>>(&mut self, imports: &mut I) -> i32 {
        let var0 = self.global20;
        var0
    }
    fn wasm_debug_debug_getRegisterC<I: Imports<Memory = M>>(&mut self, imports: &mut I) -> i32 {
        let var0 = self.global21;
        var0
    }
    fn wasm_debug_debug_getRegisterD<I: Imports<Memory = M>>(&mut self, imports: &mut I) -> i32 {
        let var0 = self.global22;
        var0
    }
    fn wasm_debug_debug_getRegisterE<I: Imports<Memory = M>>(&mut self, imports: &mut I) -> i32 {
        let var0 = self.global23;
        var0
    }
    fn wasm_debug_debug_getRegisterH<I: Imports<Memory = M>>(&mut self, imports: &mut I) -> i32 {
        let var0 = self.global24;
        var0
    }
    fn wasm_debug_debug_getRegisterL<I: Imports<Memory = M>>(&mut self, imports: &mut I) -> i32 {
        let var0 = self.global25;
        var0
    }
    fn wasm_debug_debug_getRegisterF<I: Imports<Memory = M>>(&mut self, imports: &mut I) -> i32 {
        let var0 = self.global19;
        var0
    }
    fn wasm_debug_debug_getProgramCounter<I: Imports<Memory = M>>(&mut self, imports: &mut I) -> i32 {
        let var0 = self.global26;
        var0
    }
    fn wasm_debug_debug_getStackPointer<I: Imports<Memory = M>>(&mut self, imports: &mut I) -> i32 {
        let var0 = self.global27;
        var0
    }
    fn wasm_debug_debug_getOpcodeAtProgramCounter<I: Imports<Memory = M>>(&mut self, imports: &mut I) -> i32 {
        let var0 = self.global26;
